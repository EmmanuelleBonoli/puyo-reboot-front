...
export async function generateSpecialBubblesApi(gameId: string, gameData: GameData): Promise<Bubble[]> {
  return http<Bubble[]>(`/bubble/game/${gameId}/generateSpecialBubbles`, {
    method: 'POST',
    body: gameData,
    auth: true,
  });
